...
<form>
    ...
    <table cellpadding="5"  id="laravel_datatable" class="table-bordered table-hover table-striped">
		...
		<tr>
            ...
            <a class="btn btn-info btn-sm fas fa-eye"   data-toggle="modal" data-target="#myModal{{ $p->nik }}" title="Detail Data"></a>
<!-- Modal -->
<div id="myModal{{ $p->nik }}" class="modal fade" role="dialog">
...
<!-- Modal -->  
            ...
            <!--
                        <td>
                        <a class="btn btn-danger btn-sm fas fa-trash-alt " title="Hapus Data"href="/admin/meninggal/hapus/{{$p->nik}}" onclick="return confirm('Yakin akan meghapus data ini?')"></a>
