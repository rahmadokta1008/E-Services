...
<div class="card-body" width="50%">
       ...
       <form  width="50%" method="post" action="/admin/tambahPpindah/masuk_ppindah/{{$penduduk->id}}">
  ...
  <div class="row"> 
            ...
            <div class="row"> 
                        <div class="form-group col-sm-3">
                            ...
                            <input style="width:80%;" type="date" name="tanggal_pindah" class="form-control" required="required"> 
