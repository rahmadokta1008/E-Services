...
<style type="text/css">
 ...
 <a href="/admin/datasurat" class="btn btn-primary btn-sm">Kembali</a><br><br>
  ...
  <div class="pdf">
    ...
    <center>
    <font style="" size="3" face="Times New Roman"><b><u>SURAT KETERANGAN BELUM MENIKAH</u></b></font><br>
  ...
  @foreach($penduduk as $p)
    ...
    <div class="text">
    <font size="3" face="Times New Roman">Nama tersebut diatas adalah benar-benar penduduk Kampung Ngestirahayu Kecamatan Punggur Kabupaten Lampung Tengah. Dan sepengetahuan kami orang tersebut selama berdomisili di Kampung Ngestirahayu <b><u>BELUM PERNAH MENIKAH</u></b></font><br><br>
    <font size="3" face="Times New Roman">Demikian surat keterangan ini kami buat untuk dapat dipergunakan sebagaimana mestinya</font>
      </div>
    </div>
    <div class="opd">
