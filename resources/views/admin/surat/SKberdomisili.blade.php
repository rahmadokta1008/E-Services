...
<style type="text/css">
 ...
 <a href="/admin/datasurat" class="btn btn-primary btn-sm">Kembali</a><br><br>
  ...
  @foreach($penduduk as $p)
    ...
    <div class="text">
    <font size="3" face="Times New Roman">Orang tersebut adalah benar-benar penduduk Kampung Totokaton Kecamatan Punggur Kabupaten Lampung Tengah, sepanjang sepengetahuan kami orang tersebut beradat istiadat baik.</font><br>
