...
<style type="text/css">
 ...
 <a href="/admin/datasurat" class="btn btn-primary btn-sm">Kembali</a><br><br>
  ...
  <div class="pdf">
    ...
    <center>
    <font style="" size="3" face="Times New Roman"><b><u>SURAT KETERANGAN BERDOMISILI</u></b></font><br>
  ...
  @foreach($penduduk as $p)
    <table style="margin-left: 60px;" cellpadding="3" cellspacing="3" 
         ...
         <thead>
            <tr>
              <td width="120px"><font style="" size="3" face="Times New Roman">NIK</font></td>
    ...
    <div class="text">
    <font size="3" face="Times New Roman">Orang tersebut adalah benar-benar penduduk Kampung Ngestirahayu Kecamatan Punggur Kabupaten Lampung Tengah, sepanjang sepengetahuan kami orang tersebut beradat istiadat baik.</font><br>
    
    <font size="3" face="Times New Roman">Demikian surat keterangan berdomisili ini kami buat dengan sebenar-benarnya agar dapat dipergunakan sebagaimana mestinya.</font>
    </div>
    </div>
