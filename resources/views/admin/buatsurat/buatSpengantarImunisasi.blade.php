                ...
                <a class="nav-link">
                        ...
                        <table width="80%" cellpadding="3" border="0" cellspacing="3" align="center">
                            <thead>
                                ...
                                <tr>
                                    <td align="center"><font style="" size="3" face="Times New Roman"><b><u>470/363/TK/XII/2019<u></b></font></td>
                                </tr>
...
<div class="card-body" width="50%">
    ...
    {{ method_field('PUT') }}
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="judul_surat" class="form-control" value="Surat Pengantar Imunisasi" readonly style="width:400px;">
                        </div>
                        <div class="form-group">
