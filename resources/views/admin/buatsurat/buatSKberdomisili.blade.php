...
<div class="card-body" width="50%">
    ...
    {{ method_field('PUT') }}
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="judul_surat" class="form-control" value="Surat Keterangan Berdomisili" readonly style="width:400px;">
                        </div>
                        <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <input type="date" name="tglsurat" class="form-control" required="required" style="width:400px;" value="{{ old('nohp') }}">
                        </div>
