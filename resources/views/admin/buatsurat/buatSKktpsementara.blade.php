...
<div class="card-body" width="50%">
    ...
    {{ method_field('PUT') }}
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="judul_surat" class="form-control" value="Surat Keterangan KTP Sementara" readonly style="width:400px;">
                        </div>
                        <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label style="width:180px;">Nomor KTP</label>
                            <input type="text" name="noktp" class="form-control" required="required" style="width:400px;">
                        </div>
                     <div class="form-group">
