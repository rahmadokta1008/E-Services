                ...
                <a class="nav-link">
                        ...
                        <table width="80%" cellpadding="3" border="0" cellspacing="3" align="center">
                            <thead>
                                ...
                                <tr>
                                    <td align="center"><font style="" size="3" face="Times New Roman"><b><u>474.3/363/TK/XII/2019<u></b></font></td>
                                </tr>
...
<div class="card-body" width="50%">
    ...
    {{ method_field('PUT') }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul_surat" class="form-control" value="Surat Keterangan Kematian" readonly style="width:400px;">
                        </div>
                        <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <h3 style="margin-left:37%">Terkait Kepergian Almarhum/ Almarhumah</h3>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label style="width:180px;">Di Tempat</label>
                            <input type="text" name="tempat" class="form-control" required="required" style="width:400px;">
                        </div>
                        <div class="form-group">
                            <label style="width:180px;">Penyebab</label>
                            <input type="text" name="sebabninggal" class="form-control" required="required" style="width:400px;">
                        </div>

                        <h3 style="margin-left:37%">Pelapor</h3>
                        <div class="form-group">
                            <label style="width:180px;">Nama</label>
                            <input type="text" name="pihakkedua" class="form-control" required="required" style="width:400px;">
                        </div>
                        <div class="form-group">
                            <label style="width:180px;">Hubungan</label>
                            <input type="text" name="hubungan" class="form-control" required="required" style="width:400px;">
                        </div>
       ...
       <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js" type="text/javascript"></script>
        ...
        $(document).ready(function(){
            $(document).on('change','#nik', function(e){
                ...
                console.log(id);
                $.get('{{ url('admin/p')}}/'+id, function(data){
