...
<title>Sistem Ngestirahayu</title>
...
<h5 class="text-center col-sm-25 col-md-25 pb-2 mb-2 border-bottom" style="width: 100%; padding-top:1%;"><b>Sistem Manajemen Pelayanan Desa Ngestirahayu<b></h5>
 <div class="row">
 <div class="col-sm-1 col-md-8 mx-auto p-3" style="background-color: #FFFFFF; border-radius: 7px;">
             
        <div class="form-group row" style="padding-left:10%;  background-color: #FFFFFF;">
                              
            <div class="login-logo " style="background-color: #FFFFFF;">
                <img src="{{url('AdminLTE/dist/img/logo.jpeg') }}" width="50px" height="50px">
            </div>
            
            <h1 class="text-center text-danger pb-3 mb-3 border-bottom"><b>&nbsp;SIMAYAN<b></h1>
        </div>
