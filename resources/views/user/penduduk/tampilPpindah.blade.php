...
<form>
    ...
    <table cellpadding="5" id="laravel_datatable" class="table-bordered table-hover table-striped">
		...
		<tr>
            ...
            <th width="150px">Tanggal Pindah</th>
		...
		<tr>
            ...
            <td align="center">
                ...
                <a class="btn btn-info btn-sm" href="{{ url('user/tampilPpindah/'.$p->nik) }}" class="btn btn-xs btn-success btn-lg"  data-toggle="modal" data-target="#myModal{{ $p->id }}" title="Show Data" data-toggle="modal">Detail</a>
