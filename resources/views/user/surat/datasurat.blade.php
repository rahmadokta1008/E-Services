        ...
        <td>{{$p->created_at}}</td>
           ...
           <!-- <td>{{$p->urusan}}</td>-->
            ...
            <td align="center">
                ...
                <a class="btn btn-info btn-sm fas fa-eye" title="Lihat Surat"href="/home/datasurat/lihat/{{$p->id}},{{$p->nik}},{{$p->judul_surat}}"></a>
                        
                        <a class="btn btn-primary btn-sm fa fa-print" title="Print Surat" target="_blank" href="/datasurat/cetaksurat/{{$p->id}},{{$p->nik}},{{$p->judul_surat}}"></a>
                    
                        <a class="btn btn-danger btn-sm fas fa-trash-alt " title="Hapus Data"href="/home/datasurat/hapussurat/{{$p->id}}" onclick="return confirm('Yakin akan meghapus data ini?')"></a>
