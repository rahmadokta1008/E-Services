...
<style type="text/css">
 ...
 <a href="/home/datasurat" class="btn btn-primary btn-sm">Kembali</a><br><br>
  ...
  @foreach($penduduk as $p)
    <table style="margin-left: 50px;" cellpadding="3" cellspacing="3" 
            align="right" border="0">
         <thead>
            <tr>
              <td width="140px"><font style="" size="3" face="Times New Roman">Nama</font></td>
    ...
    <div class="text">
    <font size="3" face="Times New Roman">Orang tersebut adalah benar-benar penduduk Kampung Totokaton Kecamatan Punggur Kabupaten Lampung Tengah, dan orang tersebut diatas telah <b>Berstatus {{$surat->statusnikah}}</b> sejak tahun {{$surat->tahun}}. </font><br><br>
